...
[<aspect:aqua> *128, <aspect:perditio> *128, <aspect:aer> *128, <aspect:ignis> *128, <aspect:ordo> *128, <aspect:terra> *128, <aspect:auram> *250, <aspect:praecantatio> *64, <aspect:instrumentum> *64,
<aspect:alienis> *64, <aspect:herba> *64, <aspect:vitium> *64, <aspect:exanimis> *64], <thaumcraft:thaumonomicon>,[ <thaumcraft:amulet_vis:1>, <thaumcraft:amulet_vis:1>, <forge:bucketfilled>.withTag({FluidName: "liquid_death", Amount: 1000}), <forge:bucketfilled>.withTag({FluidName: "liquid_death", Amount: 1000}), <forge:bucketfilled>.withTag({FluidName: "liquid_death", Amount: 1000}), <forge:bucketfilled>.withTag({FluidName: "liquid_death", Amount: 1000}), <thaumcraft:scribing_tools>, <thaumcraft:scribing_tools>, <thaumcraft:baubles:1>.withTag({"TC.RUNIC": 3 as byte}), <thaumcraft:baubles:1>.withTag({"TC.RUNIC": 3 as byte}), <thaumcraft:focus_2>, <thaumcraft:focus_2>, <thaumcraft:ingot:1>, <thaumcraft:ingot:1>, <thaumcraft:ingot:1>, <thaumcraft:ingot:1>]);

mods.thaumcraft.Infusion.registerRecipe("Super_stone_seeds", "UNLOCKINFUSION", <sbu:super_stone_seeds>, 20, [<aspect:aer> *30, <aspect:ignis> *30,<aspects:metallum> *30], <mysticalagriculture:stone_seeds>, [<minecraft:stone>, <mysticalagriculture:crafting:16>, <minecraft:stone>, <mysticalagriculture:mystical_fertilizer>, <thaumcraft:crystal_terra>]);

mods.thaumcraft.Infusion.registerRecipe("Void_Seed", "UNLOCKINFUSION", <thaumcraft:void_seed>, 5, [<aspect:vitium> *10], <thaumcraft:ingot>,[<minecraft:wheat_seeds>]);
...
recipes.addShaped(<thaumcraft:stone_arcane>*8, 
[[<ore:livingrock>, <sonarcore:reinforcedstoneblock>, <ore:livingrock>], 
[<sonarcore:reinforcedstoneblock>, <thaumcraft:crystal_essence:*>, <sonarcore:reinforcedstoneblock>], 
[<ore:livingrock>, <sonarcore:reinforcedstoneblock>, <ore:livingrock>]]);

recipes.addShaped(<thaumcraft:crystal_essence>.withTag({Aspects: [{amount: 1, key: "aer"}]}),
[[<thaumcraft:crystal_aer>]]);

recipes.addShaped(<thaumcraft:crystal_essence>.withTag({Aspects: [{amount: 1, key: "terra"}]}),
[[<thaumcraft:crystal_terra>]]);

recipes.addShaped(<thaumcraft:crystal_essence>.withTag({Aspects: [{amount: 1, key: "ignis"}]}),
[[<thaumcraft:crystal_ignis>]]);

recipes.addShaped(<thaumcraft:crystal_essence>.withTag({Aspects: [{amount: 1, key: "aqua"}]}),
[[<thaumcraft:crystal_aqua>]]);

recipes.addShaped(<thaumcraft:crystal_essence>.withTag({Aspects: [{amount: 1, key: "ordo"}]}),
[[<thaumcraft:crystal_ordo>]]);

recipes.addShaped(<thaumcraft:crystal_essence>.withTag({Aspects: [{amount: 1, key: "perditio"}]}),
[[<thaumcraft:crystal_perditio>]]);

recipes.addShaped(<thaumcraft:crystal_essence>.withTag({Aspects: [{amount: 1, key: "vitium"}]}),
