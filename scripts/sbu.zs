...
mods.thaumcraft.Infusion.registerRecipe("testName26", "", <sbu:super_diamond_seeds>, 20, [<aspect:metallum> *30, <aspect:cropus> *100, <aspect:vacuos> *46, <aspect:permutatio> *50, <aspect:perditio> *50, <aspect:aer> *50], <mysticalagriculture:diamond_seeds>, [<thaumcraft:crystal_aer>, <thaumcraft:crystal_aqua>, <cyclicmagic:horse_upgrade_health>, <minecraft:diamond_block>, <minecraft:diamond_block>, <mysticalagriculture:crafting:21>]);

mods.thaumcraft.Infusion.registerRecipe("testName27", "", <sbu:super_emerald_seeds>, 20, [<aspect:metallum> *30, <aspect:cropus> *100, <aspect:vacuos> *46, <aspect:permutatio> *50, <aspect:perditio> *50, <aspect:aer> *50], <mysticalagriculture:emerald_seeds>, [<thaumcraft:crystal_aer>, <thaumcraft:crystal_terra>, <tp:emerald_apple>, <minecraft:emerald_block>, <minecraft:emerald_block>, <mysticalagriculture:crafting:21>]);

mods.thaumcraft.Infusion.registerRecipe("testName28", "", <sbu:super_gold_seeds>, 15, [<aspect:metallum> *30, <aspect:cropus> *100, <aspect:vacuos> *46, <aspect:permutatio> *50, <aspect:perditio> *50], <mysticalagriculture:gold_seeds>, [<thaumcraft:crystal_ordo>, <thaumcraft:crystal_aer>, <thaumcraft:cluster:1>, <minecraft:gold_block>, <minecraft:gold_block>, <mysticalagriculture:crafting:20>]);

mods.thaumcraft.Infusion.registerRecipe("testName28", "", <sbu:super_dark_steel_seeds>, 15, [<aspect:metallum> *30, <aspect:cropus> *100, <aspect:vacuos> *46, <aspect:permutatio> *50, <aspect:perditio> *50], <mysticalagriculture:dark_steel_seeds>, [<thaumcraft:crystal_vitium>, <thaumcraft:crystal_perditio>, <enderio:item_alloy_ball:6>, <enderio:block_alloy:6>, <enderio:block_alloy:6>, <mysticalagriculture:crafting:20>]);

mods.thaumcraft.Infusion.registerRecipe("testName30", "", <sbu:super_elementium_seeds>, 15, [<aspect:metallum> *30, <aspect:cropus> *100, <aspect:vacuos> *46, <aspect:permutatio> *50, <aspect:perditio> *50], <mysticalagriculture:elementium_seeds>, [<thaumcraft:crystal_vitium>, <thaumcraft:crystal_perditio>, <botania:manaresource:9>, <botania:storage:2>, <botania:storage:2>, <mysticalagriculture:crafting:20>]);

mods.thaumcraft.Infusion.registerRecipe("testName31", "", <sbu:super_uranium_seeds>, 20, [<aspect:metallum> *30, <aspect:cropus> *100, <aspect:vacuos> *46, <aspect:permutatio> *50, <aspect:perditio> *50], <mysticalagriculture:uranium_seeds>, [<thaumcraft:crystal_ignis>, <thaumcraft:crystal_terra>, <immersiveengineering:sheetmetal:5>, <immersiveengineering:storage:5>, <immersiveengineering:storage:5>, <mysticalagriculture:crafting:20>]);

mods.thaumcraft.Infusion.registerRecipe("testName32", "", <sbu:super_iridium_seeds>, 20, [<aspect:metallum> *30, <aspect:cropus> *100, <aspect:vacuos> *46, <aspect:permutatio> *50, <aspect:perditio> *50], <mysticalagriculture:iridium_seeds>, [<thaumcraft:crystal_aer>, <thaumcraft:crystal_ordo>, <thermalfoundation:glass:7>, <thermalfoundation:storage:7>, <thermalfoundation:storage:7>, <mysticalagriculture:crafting:20>]);

mods.thaumcraft.Infusion.registerRecipe("testName33", "", <sbu:super_end_seeds>, 20, [<aspect:metallum> *30, <aspect:cropus> *100, <aspect:vacuos> *46, <aspect:permutatio> *50, <aspect:perditio> *50], <mysticalagriculture:end_seeds>, [<thaumcraft:crystal_aer>, <thaumcraft:crystal_ordo>, <cyclicmagic:glowing_chorus>, <actuallyadditions:item_misc:19>, <actuallyadditions:item_misc:19>, <mysticalagriculture:crafting:20>]);