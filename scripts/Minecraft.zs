...
recipes.addShapeless(<minecraft:dye:14>,[<ore:cropPumpkin>, <ore:cropPumpkin>]);

recipes.addShapeless(<minecraft:planks>,[<ore:cropCactus>]);

recipes.addShapeless(<minecraft:stick>,[<ore:bone>, <ore:bone>]);

recipes.addShapeless(<minecraft:stick>,[<ore:treeSapling>]);

recipes.addShapeless(<minecraft:wheat_seeds>,[<ore:cropWheat>, <ore:cropWheat>]);
...
recipes.replaceAllOccurences(<minecraft:hopper>,<bithop:pullhop>);
